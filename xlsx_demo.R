...
file_excel <- here::here("tmp", "xlsx_test.xlsx")
...
png(png_file, height=800, width=800, res=250, pointsize=8)
...
addPicture(png_file, sheet, scale = 1, startRow = 4,
           startColumn = 1)
# remove the plot from the disk
res<-file.remove(png_file)

# Save the workbook to a file...
#++++++++++++++++++++++++++++++++++++
saveWorkbook(wb, file_excel)
